...
export function Sidebar({
  ...
  onCompany, onOverview, onSearch, onFeed, onNews, onCalendar, onManagers, onIpos, onReddit, onCongress, onCot, onGuide, onRemove, newFilings = 0, newNews = 0,
}: {
  ...
  onOverview: () => void; onSearch: () => void; onFeed: () => void; onNews: () => void; onCalendar: () => void; onManagers: () => void; onIpos: () => void; onReddit: () => void; onCongress: () => void; onCot: () => void; onGuide: () => void;
